<?php
class ModifierVocabularyIntermediate extends My_Controller {
    ...
    public function index()
    {
        ...
        $dataunit = $this->adminvocabulary_model->getDataVocabularyIntermediateWithUnitId($splitURL);
        $data['dataunit'] = $dataunit;

        $this->load->view('modifiervocabularyintermediate', $data);
    }
    ...
    public function checkVocabulary(){
        ...
        if (isset($_POST['submit'])){
            ...
            if ($this->form_validation->run()){
                ...
                redirect('adminvocabulary/intermediate', 'refresh');         
        }else{
                $this->load->view('modifiervocabularyintermediate', $data);
            }
        }
