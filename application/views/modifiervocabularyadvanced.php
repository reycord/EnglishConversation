                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Modifier Vocabulary Advanced</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Modifier Vocabulary Advanced</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <ul class="list-style-none">
									<?php if(isset($admin_flag) && $admin_flag != 0) { ?>
										<form class="login100-form validate-form" action="<?php echo base_url('modifiervocabularyadvanced/checkVocabulary/')?>" method="POST" >
