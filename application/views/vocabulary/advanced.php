                                ...
                                <div class="container">
                                    <div class="row">
                                        <?php foreach ($dataunit as $value) { 
                                            if ($value['level_id'] == '3') {
                                        ?>
                                            <a href="<?php echo base_url(); ?>vocabulary/advancedunit?unitId=<?php echo $value['unit_id']; ?>" class="col-12 col-sm-6 col-lg-4" style="margin-top: 20px;">
                                                <div class="text-center" style="position:relative;z-index:1;padding:30px;border:1px solid #2b5c9a;border-radius:6px;">
                                                    <div class="icon">
                                                        <img src="<?php echo base_url(); ?>vendors/assets/images/i_vocabulary.png" alt="">
                                                    </div>
