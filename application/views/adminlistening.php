                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Admin Listening</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Admin Listening</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
									    <?php if(isset($admin_flag) && $admin_flag != 0) { ?>
											<?php foreach ($datalevel as $value) { ?>
												<a href="<?php echo base_url() . 'adminlistening/' . strtolower($value['level_name']); ?>" class="col-12 col-sm-6 col-lg-4" style="margin-top: 20px;">
