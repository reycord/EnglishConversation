                            ...
                            <section class="cool-facts-area section-padding-100-0">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <a href="<?php echo base_url(); ?>vocabulary/beginner" class="col-12 col-sm-6 col-lg-4">
                                        ...
                                        <!-- Single Cool Facts Area -->
                                        <a href="<?php echo base_url(); ?>vocabulary/intermediate" class="col-12 col-sm-6 col-lg-4">
                                            <div class="text-center" style="position:relative;z-index:1;padding:30px;border:1px solid #2b5c9a;border-radius:6px;">
                                                <div class="icon">
                                        ...
                                        <!-- Single Cool Facts Area -->
                                        <a href="<?php echo base_url(); ?>vocabulary/advanced" class="col-12 col-sm-6 col-lg-4">
                                            <div class="text-center" style="position:relative;z-index:1;padding:30px;border:1px solid #2b5c9a;border-radius:6px;">
                                                <div class="icon">
