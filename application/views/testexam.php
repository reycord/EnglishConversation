                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Test Exam</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Test Exam</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <section class="cool-facts-area section-padding-100-0">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <a href="<?php echo base_url(); ?>testexam/beginner" class="col-12 col-sm-6 col-lg-4" style="margin-top: 20px;">
                                            <div class="text-center" style="position:relative;z-index:1;padding:30px;border:1px solid #2b5c9a;border-radius:6px;">
                                                ...
                                                <h5 style="color:#404040;">Unit</h5>
                                                <h2>Beginner</h2>
                                            </div>
                                        </a>

                                        <!-- Single Cool Facts Area -->
                                        <a href="<?php echo base_url(); ?>testexam/intermediate" class="col-12 col-sm-6 col-lg-4" style="margin-top: 20px;">
                                            <div class="text-center" style="position:relative;z-index:1;padding:30px;border:1px solid #2b5c9a;border-radius:6px;">
                                                <div class="icon">
                                        ...
                                        <!-- Single Cool Facts Area -->
                                        <a href="<?php echo base_url(); ?>testexam/advanced" class="col-12 col-sm-6 col-lg-4" style="margin-top: 20px;">
                                            <div class="text-center" style="position:relative;z-index:1;padding:30px;border:1px solid #2b5c9a;border-radius:6px;">
                                                <div class="icon">
